...
values ('Enas', 'Batarfi', 'enas@example.com', '123456', '0536513037'),
...
values ('Ahmed', 'Ali', 'ahmed@example.com', '123456', '123456789'),
...
values (1, 'Home', '123 King Fahd Road', 'Apartment 5A', 'Saudi Arabia', 'Riyadh', 'Riyadh', '12345'),
...
values (1, 'Laptops', 'laptops', 'Portable computers for work and entertainment'),
...
values
-- Laptops
(1, 1, 'Dell XPS 13', 'dell-xps-13', 'Ultra-thin laptop with 4K display', 1500.00, 'dellxps13', 20,
 'https://example.com/dell_xps_13.jpg'),
(1, 2, 'MacBook Pro', 'macbook-pro', 'Powerful laptop for professionals', 2000.00, 'macbookpro', 15,
 'https://example.com/macbook_pro.jpg'),
(1, 4, 'HP Spectre x360', 'hp-spectre-x360', 'Convertible laptop with touchscreen', 1300.00, 'hpspectre360', 25,
 'https://example.com/hp_spectre_x360.jpg'),

-- Mobiles
(2, 2, 'iPhone 13 Pro', 'iphone-13-pro', 'Latest iPhone with A15 Bionic chip', 1200.00, 'iphone13pro', 30,
 'https://example.com/iphone_13_pro.jpg'),
(2, 3, 'Samsung Galaxy S22 Ultra', 'samsung-galaxy-s22-ultra', 'Flagship Android smartphone with 108MP camera', 1300.00,
 'galaxys22ultra', 25, 'https://example.com/samsung_galaxy_s22_ultra.jpg'),
(2, 1, 'Google Pixel 6 Pro', 'google-pixel-6-pro', 'Pixel perfect photography with Tensor chip', 1000.00, 'pixel6pro',
 35, 'https://example.com/google_pixel_6_pro.jpg'),

-- Earphones
(3, 3, 'AirPods Pro', 'airpods-pro', 'Active Noise Cancellation for immersive sound', 250.00, 'airpodspro', 40,
 'https://example.com/airpods_pro.jpg'),
(3, 2, 'Sony WH-1000XM4', 'sony-wh-1000xm4', 'Wireless Noise Cancelling Headphones', 300.00, 'wh1000xm4', 30,
 'https://example.com/sony_wh1000xm4.jpg'),

-- Tablets
(4, 1, 'iPad Air', 'ipad-air', 'Powerful tablet with A14 Bionic chip', 800.00, 'ipadair', 20,
 'https://example.com/ipad_air.jpg'),
(4, 1, 'Samsung Galaxy Tab S7', 'samsung-galaxy-tab-s7', 'Premium Android tablet with S Pen', 700.00, 'galaxytab7', 15,
 'https://example.com/galaxy_tab_s7.jpg'),
(4, 4, 'Microsoft Surface Pro 7', 'microsoft-surface-pro-7', 'Versatile tablet with laptop-class performance', 900.00,
 'surfacepro7', 25, 'https://example.com/surface_pro_7.jpg'),

-- Smartwatches
(5, 4, 'Apple Watch Series 7', 'apple-watch-series-7', 'The ultimate watch for a healthier life', 400.00, 'applewatch7',
 30, 'https://example.com/apple_watch_series_7.jpg'),
(5, 2, 'Samsung Galaxy Watch 4', 'samsung-galaxy-watch-4', 'Advanced smartwatch with health tracking', 350.00,
 'galaxywatch4', 25, 'https://example.com/galaxy_watch_4.jpg'),
(5, 3, 'Fitbit Versa 3', 'fitbit-versa-3', 'Fitness tracker with built-in GPS', 200.00, 'fitbitversa3', 40,
 'https://example.com/fitbit_versa_3.jpg'),

-- Cameras
(6, 3, 'Canon EOS R5', 'canon-eos-r5', 'High-resolution mirrorless camera for professionals', 3500.00, 'canoneosr5', 10,
 'https://example.com/canon_eos_r5.jpg'),
(6, 3, 'Sony Alpha A7 III', 'sony-alpha-a7-iii', 'Full-frame mirrorless camera with excellent low-light performance',
 2000.00, 'sonyalphaa7iii', 15, 'https://example.com/sony_alpha_a7iii.jpg'),
(6, 4, 'Nikon Z7 II', 'nikon-z7-ii', 'Mirrorless camera with high-resolution sensor and 4K video', 2800.00, 'nikonz7ii',
 12, 'https://example.com/nikon_z7_ii.jpg'),

-- Televisions
(7, 1, 'Samsung QLED QN90A', 'samsung-qled-qn90a', 'Immersive 4K QLED TV with Quantum HDR', 2500.00, 'samsungqn90a', 8,
 'https://example.com/samsung_qled_qn90a.jpg'),

-- Others
(8, 2, 'Samsung 32" Curved Monitor', 'samsung-32-curved-monitor', 'Immersive gaming and viewing experience', 400.00,
 'sammon32curved', 20, 'https://example.com/samsung_curved_monitor.jpg'),
(8, 3, 'Logitech G Pro Mechanical Keyboard', 'logitech-g-pro-mechanical-keyboard', 'Designed for pro-grade performance',
 150.00, 'logitechgprokb', 40, 'https://example.com/logitech_g_pro_keyboard.jpg'),
(8, 4, 'WD Elements 2TB External Hard Drive', 'wd-elements-2tb-external-hard-drive',
 'High-capacity storage for your files', 80.00, 'wdele2tb', 50, 'https://example.com/wd_elements_2tb.jpg');
...
values (1, 1, 1, 1500), -- Dell XPS 13
       (1, 7, 2, 500);
-- AirPods Pro

-- Order 2 with 2 products
insert into order_product (order_id, product_id, quantity, price)
values (2, 11, 1, 900), -- Microsoft Surface Pro 7
       (2, 20, 3, 450);
...
insert into order_product (order_id, product_id, quantity, price)
values (6, 20, 1, 150), -- Logitech G Pro Mechanical Keyboard
       (6, 18, 2, 5000);
-- Samsung QLED QN90A

-- Order 7 with 3 products
insert into order_product (order_id, product_id, quantity, price)
values (7, 10, 1, 700), -- Samsung Galaxy Tab S7
